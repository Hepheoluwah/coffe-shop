          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div data-aos="zoom-in">
                <img
                  src={BannerImg}
                  alt="Coffee beans and steaming cup"
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Small-batch beans roasted in-house, brewed to highlight natural
                  sweetness, chocolatey depth, and a lingering caramel finish. We
                  source ethically and serve with a smile—your daily ritual, done
                  right.
                </p>
